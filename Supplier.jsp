...
<form:input type="text" path="supplier_name" required="required" /><br>
<br><label><b>email_id</b></label>
<form:input type="text" path="email_id" required="required" /><br>
<br><label><b>supplier_address</b></label>
<form:input type="text" path="supplier_address" required="required" /><br>
<br><label><b>supplier_phonenumber</b></label>
<form:input type="text" path="supplier_phonenumber" required="required" /><br>
